...
export const Etapa1 = () => {
    return <>
      <Campo classe="inputMargin" tipo="email" id="email" label="E-mail:" placeholder="seuemail@ifsp.edu.br"/>
      <Campo classe="inputMargin" tipo="email" id="emailConf" label="Confirmação de E-mail:" placeholder="seuemail@ifsp.edu.br"/>
      <Campo classe="inputMargin" tipo="senha" id="senha" label="Senha:" placeholder="********"/>
      <Campo classe="inputMargin" tipo="senha" id="senhaConf" label="Confirmação de Senha:" placeholder="********"/>
    </>;
  };

  export const Etapa2 = () => {
    return <>
        <Campo classe="inputMargin" tipo="nome" id="nome" label="Nome Completo:"/>
        <Campo classe="inputMargin" tipo="nome" id="nome" label="Nome Social: "/>
        ...
        <Campo classe="inputMargin" tipo="dtNasc" id="dtNasc" label="Data de Nascimento:"/>
        ...
        <select className="input inputMargin" name="escolaridade">
        ...
        <div className="input inputMargin radio">
          <Campo tipo="radio" label="Cursando" grupo="situacao" id="curs" />
          <Campo tipo="radio" label="Completo" grupo="situacao" id="comp" />
        </div>

        <label htmlFor="instituicao"><Typography fontFamily={'poppins'}>Última instituição que frequentou:</Typography></label>
        <select className="input inputMargin" name="instituicao">
          {/* API de instituições */}
        </select>

        <label htmlFor="cidade"><Typography fontFamily={'poppins'}>Cidade onde reside:</Typography></label>
        <select className="input inputMargin" name="cidade">
          {/* API de cidades */}
        </select>

        <label htmlFor="estado"><Typography fontFamily={'poppins'}>Estado onde reside:</Typography></label>
        <select className="input inputMargin" name="estado">
          {/* API de estados */}
        </select>
    </>;
  };
  ...
  export const Etapa3 = () => {
    return (
      <div>
        ...
        <select className="input inputMargin select" name="interesse">
          <option className="option" value="orientado">Oportunidades como pessoa bolsista ou voluntária de iniciação científica.</option>
          <option className="option" value="orientador">Oportunidades como pessoa orientadora de iniciação científica.</option>
          <option className="option" value="pesquisa">Encontrar referências bibliográficas.</option>
          <option className="option" value="ic">Conhecer mais sobre IC e a plataforma.</option>
        </select>

        <label htmlFor="categorias" ><Typography fontFamily={'poppins'}>Marque 3 categorias que te interessem:</Typography></label>
        <div id="categoriasContainer" className="inputMargin">
