...
const Editais: React.FC = () => {
            ...
            case 8:
                return <>
                    <div className="renderFacul">
                        <Typography fontFamily={'poppins'}>{info[3]}</Typography>
                        <hr className="solid"></hr>
                        <Typography fontFamily={'poppins'}>Link para a página de informações de IC no portal da sua faculdade: <a href="https://cbt.ifsp.edu.br/index.php/iniciacao-cientifica">Link para a página do {info[3]}</a></Typography>
                        <button className='btnEmail btnForm' onClick={() => window.location.href = 'mailto:contato@unifesp.br'}><Typography fontFamily={'poppins'}>Enviar Email</Typography></button>
                    </div>
                    <ProgramaIndicado nomeFacul={info[3]} />
                </>
            default:
                return <NotFound text='Ainda não temos informações sobre esse campus na nossa base :(' />;
        }
    }
    ...
    return <>
        ...
        <div className="grid">
            ...
            <main className="grid-a editaisPage">
                ...
                <div className="infosEditaisUser">
                    <Typography fontFamily={'poppins'} variant='h4' fontWeight={'bold'}>Iniciação Científica para você</Typography>
